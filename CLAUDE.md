...
You are in **aurex16pp**. satellite (games) — Rust agent console for game recordings; dashboard started by hand via scripts/start-dashboard.sh, not a standing Engine.
