...
const TRACK_BPM: [u16; TRACK_COUNT] = [132, 126, 118, 108, 124, 138];
...
const TRACK0_MELODY: [u16; PATTERN_STEPS] = [
    659, 622, 587, 554, 659, 740, 784, 740, 659, 587, 554, 494, 587, 622, 659, 740,
];
const TRACK0_BASS: [u16; PATTERN_STEPS] = [
    165, 165, 123, 123, 147, 147, 110, 110, 165, 165, 123, 123, 196, 196, 147, 147,
];
const TRACK0_ARP: [u16; PATTERN_STEPS] = [
    988, 784, 659, 784, 988, 740, 622, 740, 988, 784, 659, 784, 1109, 831, 659, 831,
];

const TRACK1_MELODY: [u16; PATTERN_STEPS] = [
    311, 349, 392, 466, 523, 466, 392, 349, 311, 349, 392, 466, 587, 523, 466, 392,
];
const TRACK1_BASS: [u16; PATTERN_STEPS] = [
    78, 78, 98, 98, 116, 116, 98, 98, 73, 73, 92, 92, 110, 110, 92, 92,
];
const TRACK1_ARP: [u16; PATTERN_STEPS] = [
    622, 466, 392, 311, 698, 523, 466, 349, 622, 466, 392, 311, 784, 587, 466, 392,
];

const TRACK2_MELODY: [u16; PATTERN_STEPS] = [
    262, 294, 330, 392, 440, 392, 330, 294, 262, 294, 330, 392, 523, 440, 392, 330,
];
const TRACK2_BASS: [u16; PATTERN_STEPS] = [
    65, 65, 82, 82, 98, 98, 82, 82, 73, 73, 92, 92, 110, 110, 92, 92,
];
const TRACK2_ARP: [u16; PATTERN_STEPS] = [
    523, 392, 330, 262, 587, 440, 330, 262, 659, 494, 392, 294, 698, 523, 392, 330,
];

const TRACK3_MELODY: [u16; PATTERN_STEPS] = [
    440, 523, 587, 659, 698, 659, 587, 523, 440, 392, 349, 330, 392, 440, 523, 587,
];
const TRACK3_BASS: [u16; PATTERN_STEPS] = [
    110, 110, 131, 131, 147, 147, 131, 131, 98, 98, 82, 82, 98, 98, 110, 110,
];
const TRACK3_ARP: [u16; PATTERN_STEPS] = [
    880, 659, 523, 440, 988, 740, 587, 494, 880, 659, 523, 392, 784, 587, 466, 392,
];

const TRACK4_MELODY: [u16; PATTERN_STEPS] = [
    196, 247, 294, 247, 220, 262, 330, 262, 196, 247, 294, 330, 392, 330, 294, 262,
];
const TRACK4_BASS: [u16; PATTERN_STEPS] = [
    49, 49, 62, 62, 55, 55, 73, 73, 49, 49, 62, 62, 82, 82, 73, 73,
];
const TRACK4_ARP: [u16; PATTERN_STEPS] = [
    392, 294, 247, 196, 440, 330, 262, 220, 494, 392, 294, 247, 523, 392, 330, 262,
];

const TRACK5_MELODY: [u16; PATTERN_STEPS] = [
    554, 659, 740, 831, 988, 831, 740, 659, 554, 659, 740, 880, 1047, 988, 880, 740,
];
const TRACK5_BASS: [u16; PATTERN_STEPS] = [
    139, 139, 165, 165, 196, 196, 165, 165, 123, 123, 147, 147, 185, 185, 165, 165,
];
const TRACK5_ARP: [u16; PATTERN_STEPS] = [
    1109, 831, 659, 554, 1245, 988, 740, 622, 1109, 831, 659, 554, 1319, 988, 784, 659,
];

const TRACK0_PERC: [[u16; PATTERN_STEPS]; 4] = [
    [82, 0, 0, 82, 0, 0, 82, 0, 82, 0, 0, 82, 0, 0, 82, 0],
    [0, 0, 350, 0, 0, 350, 0, 0, 0, 0, 350, 0, 0, 350, 0, 0],
    [
        4000, 0, 0, 4000, 0, 4000, 0, 0, 4000, 0, 0, 4000, 0, 4000, 0, 0,
    ],
    [
        0, 3000, 0, 0, 3000, 0, 3000, 0, 0, 3000, 0, 0, 3000, 0, 3000, 0,
    ],
];
const TRACK4_PERC: [[u16; PATTERN_STEPS]; 4] = [
    [82, 0, 82, 0, 0, 82, 0, 82, 82, 0, 82, 0, 0, 82, 0, 82],
    [0, 350, 0, 0, 350, 0, 0, 350, 0, 350, 0, 0, 350, 0, 0, 350],
    [
        4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0,
    ],
    [
        0, 0, 3000, 0, 0, 3000, 0, 0, 3000, 0, 0, 3000, 0, 0, 3000, 0,
    ],
];
const TRACK5_PERC: [[u16; PATTERN_STEPS]; 4] = [
    [82, 0, 0, 82, 0, 0, 82, 0, 82, 0, 0, 82, 0, 0, 82, 0],
    [0, 0, 350, 0, 0, 0, 350, 0, 0, 0, 350, 0, 0, 0, 350, 0],
    [
        4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0, 4000, 0,
    ],
    [
...
const TRACK_FX: [u8; 6] = [0x13, 0x06, 0x02, 0x05, 0x12, 0x03];
